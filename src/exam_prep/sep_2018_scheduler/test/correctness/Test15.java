...
public class Test15
{
    ...
    @Test
    public void GetByConsumptionRange_ThreadExecutor_ShouldWorkCorrectly_AfterCycle()
    {
        ...
        //Assert
        Task[] actual = iterableToArray(executor.getByConsumptionRange(5, 12, true));

        Assert.assertArrayEquals(expected, actual);

        executor.cycle(100);

        Assert.assertArrayEquals(new Task[0], iterableToArray(executor.getByConsumptionRange(5, 12, true)));
    }
