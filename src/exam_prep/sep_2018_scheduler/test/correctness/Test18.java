...
public class Test18
{
    ...
    @Test
    public void GetByPriority_ThreadExecutor_ShouldReturnEmptyCollection()
    {
        ...
        Task task3 = new Task(58, 12, Priority.HIGH);
        ...
        //Assert
        Task[] actual = iterableToArray(executor.getByPriority(Priority.LOW));
